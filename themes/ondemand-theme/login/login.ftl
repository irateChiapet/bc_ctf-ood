...
<div class="card-heading" style="background: url('${url.resourcesPath}/img/accent.png') center center/cover no-repeat;"></div>
<#if realm.password>
<div class="card-body">
<div style="text-align:center;">
   <img  src="${url.resourcesPath}/img/logo.svg" alt="logo" style="height:60px;">
</div>
<h2 class="title" style="text-align:center;">Meridian Computing</h2>
<h6 class="subtitle" style="text-align:center;">MJRV6Y3UMZ5USTK7IJAVGRKEPUFA====</h6>
<form id="kc-form-login" class="form form1" return true;" action="${url.loginAction}" method="post">
   <div class="input-group">
      <label>Username*</label>
      <div>
         <input id="username" class="input--style-3 input-width" type="text" placeholder="Username" name="username">
      </div>
   </div>
   <div class="input-group">
